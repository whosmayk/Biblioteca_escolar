    ...
    <form method="POST">
        <div class="mb-3">
            <input type="text" name="nombre" class="form-control" 
               placeholder="Ej: Juan Pérez" value="<?php echo $alumno['nombre']; ?>" required>
        </div>
        <div class="mb-3">
            <label>Grado y Grupo</label>
            <input type="text" name="grado_grupo" class="form-control" 
               placeholder="Ej: 3-B, 2-A, 1-C" value="<?php echo $alumno['grado_grupo']; ?>">
        </div>
        <div class="mb-3">
            <label>Email</label>
            <input type="email" name="email" class="form-control" 
               placeholder="ejemplo@escuela.edu" value="<?php echo $alumno['email']; ?>" required>
        </div>
